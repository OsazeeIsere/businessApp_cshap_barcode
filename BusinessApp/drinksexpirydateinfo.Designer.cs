...
namespace BusinessApp
{
	...
	public partial class drinksexpirydateinfo : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.import.Text = "Import for The" + "\r" + "\n" + "    First Time";
			...
			//lsvitems
			//
			this.lsvitems.Columns.AddRange(new System.Windows.Forms.ColumnHeader[] {this.ColumnHeader2, this.ColumnHeader3, this.ColumnHeader4, this.ColumnHeader5, this.ColumnHeader6, this.ColumnHeader1, this.ColumnHeader11, this.ColumnHeader7, this.ColumnHeader8, this.ColumnHeader9, this.ColumnHeader10});
			...
			this.ComboBox1.Items.AddRange(new object[] {"All Products", "Products That Will Expire This Month", "Three Months(3) Time", "Six Months(6) Time", "Above Six Months(6) Time", "Products Already Expired"});
			...
			//
			this.AutoScaleDimensions = new System.Drawing.SizeF(10.0F, 20.0F);
			...
			this.Font = new System.Drawing.Font("Microsoft Sans Serif", 12.0F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, Convert.ToByte(0));
...
//INSTANT C# NOTE: Converted design-time event handler wireups:
			base.Load += new System.EventHandler(drinksexpirydateinfo_Load);
